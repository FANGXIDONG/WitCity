...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = @"下拉刷新";
        self.releaseToRefreshText = @"松开立即刷新";
        self.refreshingText = @"正在刷新...";
        
        
        self.pandaImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, -134*kWidthRatio, kScreenWidth, 134*kWidthRatio)];
        self.pandaImage.image = [UIImage imageNamed:@"down_refresh"];
        [self addSubview:self.pandaImage];
...
//    CGFloat statusWidth = self.mj_width;
    // 1.状态标签
    self.statusLabel.frame = CGRectMake(0, 10, kScreenWidth, 20);
//    
//    // 2.时间标签
