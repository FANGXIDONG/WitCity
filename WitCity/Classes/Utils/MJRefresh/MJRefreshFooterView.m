...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = @"上拉加载更多数据";
        self.releaseToRefreshText = @"松开加载更多数据";
        self.refreshingText = @"正在加载数据...";
    }
    return self;
}
...
- (void)layoutSubviews
{
    ...
    self.statusLabel.frame = CGRectMake(self.arrowImage.right, self.arrowImage.top - 4, 100, 20);
}
