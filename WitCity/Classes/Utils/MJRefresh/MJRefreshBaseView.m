...
{
    if (!_arrowImage) {
//        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"arrow_down_refresh"]];
        
        UIImage *img = [UIImage imageNamed:MJRefreshSrcName(@"arrow")];
        UIImageView *arrowImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, img.size.width, img.size.height)];
        //MJRefreshSrcName(@"arrow_down_refresh")
        arrowImage.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        arrowImage.image = img;//[YLGIFImage imageNamed:@"底部加载@2x.gif"];
...
- (void)layoutSubviews
{
    ...
    self.arrowImage.center = CGPointMake(arrowX, 22);
