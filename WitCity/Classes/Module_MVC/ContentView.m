...
- (instancetype)initWithFrame:(CGRect)frame Width:(CGFloat)width model:(EveryDayModel *)model collor:(UIColor *)collor{
    ...
    if (self) {
        ...
        _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(5, 5, WINDOW_WIDTH, 30)];
        ...
        _littleLabel = [[UILabel alloc]initWithFrame:CGRectMake(5, 46, WINDOW_WIDTH, 20)];
        ...
        _descripLabel = [[UILabel alloc]initWithFrame:CGRectMake(5, 80, WINDOW_WIDTH - 10, 90)];
        ...
        _collectionCustom = [[CustomView alloc]initWithFrame:CGRectMake(5, y, (WINDOW_WIDTH - 10) / 4, 30) Width:width LabelString:model.collectionCount collor:collor];
        [self addSubview:_collectionCustom];
        
        _shareCustom = [[CustomView alloc]initWithFrame:CGRectMake((WINDOW_WIDTH - 10) / 4 + 5, y, (WINDOW_WIDTH - 10) / 4, 30) Width:width LabelString:model.shareCount collor:collor];
        [self addSubview:_shareCustom];
        _cacheCustom = [[CustomView alloc]initWithFrame:CGRectMake(_shareCustom.frame.origin.x + _shareCustom.frame.size.width, y, (WINDOW_WIDTH - 10) / 4, 30) Width:width LabelString:@"缓存" collor:collor];
        [self addSubview:_cacheCustom];
        _replyCustom = [[CustomView alloc]initWithFrame:CGRectMake(_cacheCustom.frame.origin.x + _cacheCustom.frame.size.width, y, (WINDOW_WIDTH - 10) / 4, 30) Width:width LabelString:model.replyCount collor:collor];
