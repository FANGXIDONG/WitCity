...
#import "DDFilterDataTableView.h"
#import "UIView+YLPlus.h"

#define SCREEN_HEIGHT [UIScreen mainScreen].bounds.size.height

@interface DDConditionFilterView()<DDFilterDataTableViewDelegate>
{
    // 第1组筛选 按钮
    ...
    // 对应三个下拉框
    DDFilterDataTableView *_filterTableView1;
    DDFilterDataTableView *_filterTableView2;
    DDFilterDataTableView *_filterTableView3;
...
@implementation DDConditionFilterView

+(instancetype)conditionFilterViewWithFilterBlock:(FilterBlock)filterBlock
{
    DDConditionFilterView *conditionFilter = [[DDConditionFilterView alloc] initWithFrame:CGRectMake(0, 0, WINDOW_WIDTH, 40)];
...
- (void)createSubView
{
    ...
    _dataSource1Btn = [self buttonWithLeftTitle:@"" titleColor:UIColorFromRGB(0x333333) Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor whiteColor] RightImageName:@"PR_filter_choice" Frame:CGRectMake(0, 0, (WINDOW_WIDTH-1)/3, 40)];
    ...
    _dataSource2Btn = [self buttonWithLeftTitle:@"" titleColor:UIColorFromRGB(0x333333) Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor whiteColor] RightImageName:@"PR_filter_choice" Frame:CGRectMake(_dataSource1Btn.x+_dataSource1Btn.width+0.5, 0, (WINDOW_WIDTH-1)/3, 40)];
    ...
    _dataSource3Btn = [self buttonWithLeftTitle:@"" titleColor:UIColorFromRGB(0x333333) Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor whiteColor] RightImageName:@"PR_filter_choice" Frame:CGRectMake(_dataSource2Btn.x+_dataSource2Btn.width+0.5, 0, (WINDOW_WIDTH-1)/3, 40)];
    ...
    UILabel *bottomLine = [[UILabel alloc] initWithFrame:CGRectMake(0, 39.5, WINDOW_WIDTH, 0.5)];
...
- (void)prepareUIWithBtn:(UIButton *)btn
{
    ...
    if (btn == _dataSource1Btn) {
        _filterTableView1 = [[DDFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom, self.width, 64)];
        ...
        _filterTableView2 = [[DDFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom, self.width, 0)];
        ...
        _filterTableView3 = [[DDFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom, self.width, 0)];
...
#pragma mark - DDFilterDataTableViewDelegate 选择筛选项
