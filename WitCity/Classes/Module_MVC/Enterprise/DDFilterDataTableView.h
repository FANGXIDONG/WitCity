...
@protocol DDFilterDataTableViewDelegate <NSObject>
...
@interface DDFilterDataTableView : UITableView

@property (nonatomic,weak) id<DDFilterDataTableViewDelegate> sortDelegate;
/** 选中的数据*/
