...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"si_radio_unchecked"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"si_radio_checked"] forState:UIControlStateSelected];
